...
var ykp = {
	...
	//api_url: 'http://www.my-finance1.com',
    //api_url: 'http://my-api-finance.com',
    version: '1.0.1',
    /**
     * 私有构造函数
     */
...
//          it.showBlock();
            ...
            var msg = option.msg || '数据玩命加载中...';
            var html = '<div class="dataTables_processing" id="onProcess" style="z-index:1100">' + '<div id="mark"></div><div class="note-success" style="padding:10px;border-radius:10px;">' + '<img  style="margin-right:10px;top:-1px;display: inline-block; position:relative" src="data:image/png;base64," class="rotate"/>' + '<span style="">' + msg + '</div>' + '</div>'
            div.innerHTML = html;
            var Fun = function () {
            };
            Fun = function () {
...
//      option.data.request_url = it.api_url + ajaxOption.url;
		...
		ajaxOption.data['login_token'] = it.getCookie('login_token');
    ...
    showMessage: function (msg, detail, buttons) {
        var it = this;
        var html = [msg, '<span class="ajax_show_detail" style="position: absolute;left: 0; z-index:1200;top: 0;padding: 10px;">&nbsp;&nbsp;&nbsp;</span>',
    ...
    list: function (obj) {
        ...
        var div = document.createElement("div");
        var html = '<div class="dataTables_processing" id="onProcess" style="z-index:5000">' + '<div id="mark"></div><div class="note-success" style="padding:10px;border-radius:10px;">' + '<img  style="margin-right:10px;top:-1px;display: inline-block; position:relative" src="data:image/png;base64," class="rotate"/>' + '<span style="">' + '数据玩命加载中...' + '</div>' + '</div>'
        div.innerHTML = html;
        var Fun = function () {
        };
        Fun = function () {
        ...
        it.doAjax({
            ...
            success: function (res) {
                ...
                $('._num').html('共' + res.data.totalCount + '条数据');
                if (option.loadList && typeof option.loadList === 'function') {
                    ...
                    if (page_no && total && option.pageBar && option.pageBar.id) { //分页组件
                        ...
                        $(option.pageBar.id).jqPaginator({
                            ...
                            first: '<li class="first"><a href="javascript:void(0);"><i class="glyphicon glyphicon-step-backward"></i><\/a><\/li>',
                            ...
                            last: '<li class="last"><a href="javascript:void(0);"><i class="glyphicon glyphicon-step-forward"></i><\/a><\/li>',
    ...
    alert: function (msg, buttons) {
        ...
        $('.pop_block').remove();
        var html = [
            '<div class="pop_block" style="position:fixed;top:0px;width:100%;height:100%;z-index:9999;background:rgba(0,0,0,0.2);">',
//            '<div class="mask"  style="height:', maskHeight,
//            'px;background-color:#000;opacity:0.2;position:fixed;width:',
//            body_width, 'px;z-index:60;">',
//            '</div>',
            '<div class="pop" style="background-color:#FFF; z-index:1200;opacity:1;padding:10px 0 0;width:',
            body_width, 'px;text-align:center;z-index:9999;position:fixed;border:3px solid #f5f4f5;left:45%;top:45%;">',
     ...
     * @returns {undefined}
     */
    prompt: function (str, option) {
        var str = str ? str : 'API数据错误';
        //var id = 'global_' + parseInt(Math.random() * 100, 10);
        var id = 'global_prompt';
        var html = [
            '<div class="' + id + '" class="global_shade" style="z-index:1050"">',
            '<div style="width:260px;height: 45px;position: fixed;left:50%;top:50%;margin-left:-130px; z-index:1050">',
        ...
        $('.' + id).remove();
        var option = option || {};
        var startTime = option.startTime ? option.startTime : 0;
        var endTime = option.endTime ? option.endTime : 1000;
