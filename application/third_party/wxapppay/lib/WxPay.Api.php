...
require_once "WxPay.Config." . ENVIRONMENT . ".php";
...
class WxPayApi {
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        $result['nonce_str2'] = $nonce_str;
        $result['sign2'] = $inputObj->GetSign();
//        var_dump($result);die;
        ...
        $wx_pay_database = new WxPayDataBase();
        $wx_pay_database->FromParam($to_app_result);
        $new_sign = $wx_pay_database->MakeSign();
        $to_app_result['sign'] = $new_sign;
        $to_app_result['result_code'] = isset($result['result_code']) ? $result['result_code'] : '';
        $to_app_result['return_code'] = isset($result['return_code']) ? $result['return_code'] : '';

        return $to_app_result;
    }
