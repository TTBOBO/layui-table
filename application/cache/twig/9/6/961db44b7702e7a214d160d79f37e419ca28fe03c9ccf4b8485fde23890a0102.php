...
/* admin/currency/editroomcate.html */
class __TwigTemplate_eb39877a28d0e27f773b4050ba6ab9acaddaac11db07de486c0a7e7376919e0b extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/currency/editroomcate.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/currency/editroomcate.html", 9)->display($context);
        // line 10
...
\t\t\t\t\tel: \".layui-form\"
\t\t\t\t},*/  //检索  默认  ''  要检索时  添加检索
\t\t\t\tinfoUrl:\"/admin/im/api_roomcate/info\",   //编辑详情接口
...
";
    ...
    {
        return "admin/currency/editroomcate.html";
    }
