...
/* admin/im/editShop.html */
class __TwigTemplate_4f9018b8a69f4e09617ff1f08231611e00d2ffa42d5b0aa42fb58aabac7f58a1 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/im/editShop.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {
\t\tmargin: 10px;
...
";
        // line 54
        $this->loadTemplate("admin/crumbs1.html", "admin/im/editShop.html", 54)->display($context);
        // line 55
...
\t\t\t\t<div class=\"layui-input-inline\">
\t\t\t\t\t<input type=\"text\" name=\"title\" lay-verify=\"\" autocomplete=\"off\" placeholder=\"请输入楼层\" class=\"lc layui-input\">
\t\t\t\t\t<div class=\"layui-upload\">
...
\t\t\t\t<button type=\"button\" id=\"addXn\" class=\"layui-btn layui-btn-sm\" style=\"margin-left: 20px;\">添加虚拟办公服务</button>
\t\t\t\t<hr />
\t\t\t\t
\t\t\t</div>
\t\t</div>
...
\t\t\t\t<button type=\"button\" id=\"addOther\" class=\"layui-btn layui-btn-sm\" style=\"margin-left: 20px;\">添加虚拟办公服务</button>
\t\t\t\t<hr />
\t\t\t\t
\t\t\t</div>
\t\t</div>
...
\t\t\t<div id=\"pt\">
\t\t\t\t<button type=\"button\" class=\"layui-btn la\tyui-btn-sm\" style=\"float: left; margin-right: 10px; position: relative;\">配套名称<i class=\"fa fa-remove\" style=\"position: absolute; right: 3px;\"></i></button>
\t\t\t</div>
...
\t\t<div class=\"layui-input-inline\" style=\"width: 700px;\">
\t\t\t<div id=\"labelGroup\">
\t\t\t\t<button type=\"button\" class=\"layui-btn layui-btn-sm labelBtn\" style=\"float: left; margin-right: 10px;  position: relative;\">设施名称<i class=\"fa fa-remove\" style=\"position: absolute; right: 3px;\"></i></button>
\t\t\t</div>
...
\t\t\t\tvar num = 1,
\t\t\t\t\tserviceArr = [];
\t\t\t\tit.fictitiousService = ''; //虚拟服务存放
\t\t\t\tit.otherService = ''; //其他服务存放
\t\t\t\tit.lc = []; //楼层存放地
\t\t\t\tit.confirm = false;
\t\t\t\tit.serviceList = [];
\t\t\t\tform.render();
...
\t\t\t\t\t\tlayer.msg('请输入再添加');
\t\t\t\t\t} else {
\t\t\t\t\t\tcontent = '<button type=\"button\" class=\"layui-btn layui-btn-sm labelName\" style=\"float: left; margin-right: 10px; position: relative;\">' + val + '<i class=\"fa fa-remove\" style=\"position: absolute; right: 3px;\"></i></button>';
\t\t\t\t\t\t\$('#pt').append(content);
\t\t\t\t\t\t\$('.ptlabel').val('');
...
\t\t\t\t\t\tlayer.msg('请输入再添加');
\t\t\t\t\t} else {
\t\t\t\t\t\tcontent = '<button type=\"button\" class=\"layui-btn layui-btn-sm labelBtn\" style=\"float: left; margin-right: 10px; position: relative;\">' + val + '<i class=\"fa fa-remove\" style=\"position: absolute; right: 3px;\"></i></button>';
...
\t\t\t\t//添加虚拟办公服务
\t\t\t\t\$('#addXn').click(function() {
\t\t\t\t\t\$('#fictitiousService').append(`<div>
\t\t\t\t\t\t<div class=\"layui-inline\">
\t\t\t\t\t\t\t<label class=\"layui-form-label\" style=\"width: 40px;\">名称</label>
\t\t\t\t\t\t\t<div class=\"layui-input-inline\" style=\"width: 100px;\">
\t\t\t\t\t\t\t\t\${it.fictitiousService}
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"layui-inline\">
...
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"layui-inline\">
\t\t\t\t\t\t\t<button type=\"button\" id=\"addOther\" class=\"layui-btn layui-btn-sm closeOther\" style=\"float: left;\"><i class=\"layui-icon\">&#x1006;</i></button>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>`);
\t\t\t\t\tform.render();
...
\t\t\t\t\t\t\t<div class=\"layui-input-inline\">
\t\t\t\t\t\t\t\t<input type=\"text\" name=\"title\" lay-verify=\"\"  autocomplete=\"off\" placeholder=\"请输入楼层\" class=\"layui-input lc\">
\t\t\t\t\t\t\t\t<div class=\"layui-upload\">
\t\t\t\t\t\t\t\t\t<div class=\"layui-upload-list\">
...
\t\t\t\t\t\$('.lc').each(function() {
\t\t\t\t\t\tif(\$(this).val()) {
\t\t\t\t\t\t\tit.lc.push(`<option value=\"\${\$(this).val()}\">\${\$(this).val()}</option>`);
\t\t\t\t\t\t\tstatus = true;
\t\t\t\t\t\t} else {
\t\t\t\t\t\t\tstatus = false;
\t\t\t\t\t\t\treturn false;
...
\t\t\t\t//获取虚拟服务
\t\t\t\tit.getfictitiousService(it);
\t\t\t\t//获取其他服务
\t\t\t\tit.getOtherService(it);
\t\t\t\t
\t\t\t\t
\t\t\t\t//添加服务列表
...
\t\t\t\t\tvar qdList = `<div class=\"layui-collapse\" lay-accordion=\"\">
\t\t\t\t        <div class=\"layui-colla-item\">
\t\t\t\t          <h2 class=\"layui-colla-title\">清单</h2>
\t\t\t\t          <div class=\"layui-colla-content\">`;
\t\t\t\t\tvar content = `<div >
...
\t\t\t\t\t</div>
\t\t\t\t\t    <div class=\"layui-input-inline\">
\t\t\t\t\t      <input type=\"checkbox\" name=\"list\" lay-skin=\"primary\" value=\"物品清单\" title=\"物品清单\">
\t\t\t\t\t    </div>
\t\t\t\t`;

\t\t\t\t\t\$('#serviceList').append(content + con + btn +qdList +'</div></div></div></div>');

\t\t\t\t\t\$('.addpeople').unbind('click').click(function() {
\t\t\t\t\t\t\$(con + btn1 +qdList + '</div></div></div></div>').insertAfter(\$(this).parent());
...
\t\t\t\t\tform.render();
\t\t\t\t\t
\t\t\t\t\t\$('#serviceList').find(\"input[type=checkbox]\").change(function() {
\t\t\t\t\t\tvar statu = \$(this).id(':checked');
\t\t\t\t\t\talert(statu)
\t\t\t\t\t})
\t\t\t\t}
\t\t\t})
...
\t\tgetfictitiousService: function(it) {
\t\t\tykp.doAjax({
...
\t\t\t\t\t}
\t\t\t\t\tcontent += '</select>';
\t\t\t\t\tit.fictitiousService = content;
\t\t\t\t}
\t\t\t})
\t\t},
\t\tgetOtherService: function(it) {
\t\t\tykp.doAjax({
\t\t\t\turl: \"/admin/api_product/grid\",
\t\t\t\tmethod: \"post\",
\t\t\t\tdata: {
