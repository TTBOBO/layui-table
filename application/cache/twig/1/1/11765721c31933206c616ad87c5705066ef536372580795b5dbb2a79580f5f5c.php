...
/* admin/nm/info_notice_type.html */
class __TwigTemplate_6b00caad492a6f50aa46ecb55d28469c36e3d12e016a3bbb2984b012457f1d54 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/nm/info_notice_type.html", 1)->display($context);
        // line 2
        echo "<style>.layui-form-label {width: 100px !important;}</style>
";
        // line 3
        $this->loadTemplate("admin/crumbs1.html", "admin/nm/info_notice_type.html", 3)->display($context);
        // line 4
...
\t\t\t\tykp.doAjax({
\t\t\t\t\turl: '/admin/nm/api_notice_type/info ',
\t\t\t\t\tmethod: \"post\",
\t\t\t\t\tdata: {
\t\t\t\t\t\tfilter : \"id=\" + result.id
\t\t\t\t\t},
...
";
    ...
    {
        return "admin/nm/info_notice_type.html";
    }
