...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/product/editService.html", 9)->display($context);
        // line 10
...
\t\t\t\t\t{type: \"radio\",name: \"服务类型\",block:true,field: \"type\",sOption: {0: \"虚拟服务\",1: \"实体服务\"}},
\t\t\t\t\t{type: \"select\",name: \"限制次数\",field: \"is_limit_num\",sOption: {0: \"不限制\",1: \"限制\"}},
//\t\t\t\t\t{type: \"citySelect\",name: \"限制次数\",block:true,field: \"is_limit_num\",city:['province','city','area','北京']},
...
\t\t\t\t\t{type: \"upload\",name: \"图片\",field: \"pics\",uploadUrl:\"http://www.my-haimai.com/api/api_common/upload_file\"},
