...
/* admin/im/info_channel_type.html */
class __TwigTemplate_df5349239a038ee1f9de2632b877269fb301f5d6d9166fb9a98de222f0541066 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/im/info_channel_type.html", 1)->display($context);
        // line 2
        echo "<style>.layui-form-label {width: 100px !important;}</style>
";
        // line 3
        $this->loadTemplate("admin/crumbs1.html", "admin/im/info_channel_type.html", 3)->display($context);
        // line 4
...
\t\t\t\tykp.doAjax({
\t\t\t\t\turl: '/admin/im/Api_channel_cate/info',
\t\t\t\t\tmethod: \"post\",
\t\t\t\t\tdata: {
\t\t\t\t\t\tfilter : \"id=\" + result.id
\t\t\t\t\t},
...
";
    ...
    {
        return "admin/im/info_channel_type.html";
    }
