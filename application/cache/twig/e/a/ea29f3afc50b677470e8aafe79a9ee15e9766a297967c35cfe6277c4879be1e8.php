...
/* admin/product/addvirProduct.html */
class __TwigTemplate_54d32db9abe67d9b33910e54ae693d7616ef6f58aaf7373cab3d9b26762121d7 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/product/addvirProduct.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 10
        $this->loadTemplate("admin/crumbs1.html", "admin/product/addvirProduct.html", 10)->display($context);
        // line 11
...
\t\t\t\tel: \".layui-form\",
\t\t\t\tlist: [
\t\t\t\t\t{type: \"text\",name: \"产品名称\",verify:\"required\",block:true,field: \"name\"},
...
\t\t\t\t\t{type: \"select\",name: \"服务列表\",verify:\"required\",multiple:true,block:true,field: \"service_list\",url:\"/admin/api_product/grid\",colKey:\"id\",colName:\"name\"},
...
\t\t\t\t},  //检索  默认  ''  要检索时  添加检索
\t\t\t\tinfoUrl:\"\",   //编辑详情接口
\t\t\t\taddEditUrl:'/admin/Api_vir_product/update_or_add', //添加的接口 
\t\t\t\tprevUrl:'";
        // line 50
        echo twig_escape_filter($this->env, (isset($context["base_url"]) ? $context["base_url"] : null), "html", null, true);
        echo "/admin/product/virProduct'   //添加成功返回的页面
\t\t\t});
\t\t\t
\t\t\t
\t\t},
\t});
    ...
    {
        return "admin/product/addvirProduct.html";
    }
...
/* 				infoUrl:"",   //编辑详情接口*/
/* 				addEditUrl:'/admin/Api_vir_product/update_or_add', //添加的接口 */
/* 				prevUrl:'{{base_url}}/admin/product/virProduct'   //添加成功返回的页面*/
/* 			});*/
/* 			*/
/* 			*/
/* 		},*/
