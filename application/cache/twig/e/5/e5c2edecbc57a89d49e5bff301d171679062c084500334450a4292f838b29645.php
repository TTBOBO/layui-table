...
/* admin/product/edit_presend_item.html */
class __TwigTemplate_620283fed34785b618226f39927f333ce37c1fababc8d665799593f8e1d81ca1 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/product/edit_presend_item.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/product/edit_presend_item.html", 9)->display($context);
        // line 10
...
\t\t\t\t\tel: \".layui-form\"
\t\t\t\t},  //检索  默认  ''  要检索时  添加检索
\t\t\t\tinfoUrl:\"/admin/api_presend_item/info\",   //编辑详情接口
...
\t});
    ...
    {
        return "admin/product/edit_presend_item.html";
    }
