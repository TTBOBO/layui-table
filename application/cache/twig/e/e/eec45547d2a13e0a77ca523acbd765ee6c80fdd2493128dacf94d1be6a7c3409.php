...
/* admin/product/editvirProduct.html */
class __TwigTemplate_769d73552bd8d314a83f1a9f144326faa4fc4b0bfe7cff817930804bb0279f56 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/product/editvirProduct.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 10
        $this->loadTemplate("admin/crumbs1.html", "admin/product/editvirProduct.html", 10)->display($context);
        // line 11
...
\t\t\t\t\t{type: \"select\",name: \"服务列表\",verify:\"required\",field: \"service_list\",multiple:true,block:true,url:\"/admin/api_product/grid\",colKey:\"id\",colName:\"name\"},
...
\t\t\t\t\tel: \".layui-form\"
\t\t\t\t},  //检索  默认  ''  要检索时  添加检索
\t\t\t\tinfoUrl:\"/admin/Api_vir_product/info\",   //编辑详情接口
...
\t});
    ...
    {
        return "admin/product/editvirProduct.html";
    }
