...
/* admin/currency/editNews.html */
class __TwigTemplate_33a584ddb7c904d580eb8eb59064e887fc91113b6b5107c4f33f5b89e4d21c1d extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/currency/editNews.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/currency/editNews.html", 9)->display($context);
        // line 10
...
\t\t\thm.showAddEdit({
\t\t\t\tel: \".layui-form\",
\t\t\t\tlist: [{type: \"text\",name: \"id\", display:true,field: \"pm_news.id\",verify:\"\"},
...
\t\t\t\t],
\t\t\t\tselectKey:\"pm_news.id\",   //列字段id   例: id, product_id
\t\t\t\t/*verifyData:{
\t\t\t\t\toption: [{
\t\t\t\t\t\tverifyDate: \"password\"
\t\t\t\t\t}, {
...
";
    ...
    {
        return "admin/currency/editNews.html";
    }
