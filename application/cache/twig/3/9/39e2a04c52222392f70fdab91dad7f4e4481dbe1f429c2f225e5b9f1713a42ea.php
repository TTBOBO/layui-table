...
/* admin/auser/addbanner.html */
class __TwigTemplate_4f00674bc5ac0969641171637c64331042bd43926b72ccf5f714a69a6ae5d394 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/auser/addbanner.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/auser/addbanner.html", 9)->display($context);
        // line 10
...
\t\t\t\tprevUrl:'";
        ...
        echo "/admin/auser/business_dynamics'   //添加成功返回的页面
\t\t\t});
\t\t},
\t});
</script>
...
";
    ...
    {
        return "admin/auser/addbanner.html";
    }
...
/* 				infoUrl:"",   //编辑详情接口*/
/* 				addEditUrl:'/admin/am/Api_ads/update_or_add', //添加的接口 */
/* 				prevUrl:'{{base_url}}/admin/auser/business_dynamics'   //添加成功返回的页面*/
/* 			});*/
/* 		},*/
/* 	});*/
/* </script>*/
