...
/* admin/product/addEntityProduct.html */
class __TwigTemplate_00b7f15387d5a21db8e1d29bae1c318b9fdfeb5d9fc8e7dc575499a82d465e08 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/product/addEntityProduct.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 10
        $this->loadTemplate("admin/crumbs1.html", "admin/product/addEntityProduct.html", 10)->display($context);
        // line 11
...
\t\t\t\t\t{type: \"upload\",name: \"产品主图\",verify:\"\",field: \"thumb\",},
\t\t\t\t\t{type: \"text\",name: \"图片地址\",verify:\"required\",field: \"pics\",height:180,w:180},
...
\t\t\t\t\t{type: \"checkbox\",name: \"赠送项目\",verify:\"required\",block:true,field: \"presend_items\",url:\"/admin/api_presend_item/grid\",filter:\"product_type_id = 2\",colKey:\"id\",colName:\"name\"},
...
\t});
    ...
    {
        return "admin/product/addEntityProduct.html";
    }
