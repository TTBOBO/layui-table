...
/* admin/user/editCompany.html */
class __TwigTemplate_0bf46bc834ee2f9cea9331279df1659647d3f70e98aa3b12b1f8f7bcc32296ef extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/user/editCompany.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/user/editCompany.html", 9)->display($context);
        // line 10
...
\t\t\t\t\t{type: \"text\",name: \"公司网址\",field: \"website\"},
\t\t\t\t\t{type: \"text\",name: \"公司QQ\",field: \"qq\"},
...
\t\t\t\t\t{type:'text',name:'联系手机',field:'mobile'}
\t\t\t\t],
...
\t});
    ...
    {
        return "admin/user/editCompany.html";
    }
