...
/* admin/currency/addproduct_service.html */
class __TwigTemplate_00f982b8bccf1e4255538301a7ac26202f8e3bd635fa8d60c9d89a800a659785 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/currency/addproduct_service.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/currency/addproduct_service.html", 9)->display($context);
        // line 10
...
\t\t\t\t\t{type: \"text\",name: \"产品名称\",block:true,field: \"pm_product_service.name\",verify:\"required\"},
\t\t\t\t\t{type: \"text\",name: \"访问量\",verify:\"required\",field: \"pm_product_service.vist_num\"},
...
\t\t\t\t\t{type: \"text\",name: \"市场价\",verify:\"required\",field: \"pm_product_service.price\"},
\t\t\t\t\t{type: \"text\",name: \"会员价\",verify:\"required\",field: \"pm_product_service.v_price\"},
\t\t\t\t\t{type: \"text\",name: \"买点\",verify:\"required\",field: \"pm_product_service.buy_point\"},
\t\t\t\t\t{type: \"text\",name: \"收藏量\",verify:\"required\",field: \"pm_product_service.collect_num\"},
...
";
    ...
    {
        return "admin/currency/addproduct_service.html";
    }
    ...
    {
        return array (  78 => 54,  32 => 10,  30 => 9,  21 => 2,  19 => 1,);
    }
}
