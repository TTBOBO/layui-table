...
/* admin/user/editCompanyContract.html */
class __TwigTemplate_01b779e5e6bf642b7bb6307d5c4a6d818fb268992f1363ee6dc1eb79272e7bc9 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/user/editCompanyContract.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/user/editCompanyContract.html", 9)->display($context);
        // line 10
...
\t\t\thm.showAddEdit({
\t\t\t\tel: \".layui-form\",
\t\t\t\tlist: [{type: \"text\",name: \"id\",display:true, field: \"um_company_contract.id\"},
...
\t\t\t\t],
\t\t\t\tselectKey:\"um_company_contract.id\",   //列字段id   例: id, product_id
//\t\t\t\tverifyData:{
//\t\t\t\t\toption: [{
//\t\t\t\t\t\tverifyDate: \"password\"
//\t\t\t\t\t}, {
...
";
    ...
    {
        return "admin/user/editCompanyContract.html";
    }
