...
/* front/common/banner.html */
class __TwigTemplate_fa873abbc426ddb971bf804e410fe74b149476dee6af25366a96c22519a7ed9e extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        // line 1
        echo "<style>
    #bt_slide_ol li{width:15px;height:15px;border-radius:50%;background:#999;border:0;margin:0 5px;}
    #bt_slide_ol .active{width:15px;height:15px;background:#fff;border:0;box-shadow:0 0 10px #ccc;margin:0 5px;}
...
";
    ...
    {
        return "front/common/banner.html";
    }
