...
/* admin/currency/addFrame.html */
class __TwigTemplate_7d6b8149f4d375003be3f7c9be90e814cb190451ec8732d7ac20e66cdee723b7 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/currency/addFrame.html", 1)->display($context);
        // line 2
        echo "<style>
\tbody {margin: 10px;}
...
";
        // line 9
        $this->loadTemplate("admin/crumbs1.html", "admin/currency/addFrame.html", 9)->display($context);
        // line 10
...
\t\t\t\tel: \".layui-form\",
\t\t\t\tlist: [
\t\t\t\t\t{type: \"text\",name: \"判断字段\",block:true,field: \"name\",verify:\"required\"},
\t\t\t\t\t{type: \"text\",name: \"标题名称\",block:true,verify:\"required\", field: \"title\"},
\t\t\t\t\t{type: \"select\",name: \"类型\",field: \"type\",verify:\"required\",sOption: {0: \"其它\",1: \"顶部导航\",2: \"关于我们\",3: \"商务合作\",4: \"隐私策略\",5: \"帮助中心\"}},
\t\t\t\t\t{type: \"text\",name: \"网址url\",block:true,verify:\"url\",field: \"url\"},
...
";
    ...
    {
        return "admin/currency/addFrame.html";
    }
