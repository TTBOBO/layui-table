...
/* admin/user/infoMessege.html */
class __TwigTemplate_c05b5537944e2b8f8251008a66accfca2aa48ae4f3378005dd4523abde2e6bb1 extends Twig_Template
{
    ...
    {
        // line 1
        $this->loadTemplate("admin/iheader.html", "admin/user/infoMessege.html", 1)->display($context);
        // line 2
        echo "<style>.layui-form-label {width: 100px !important;}</style>
";
        // line 3
        $this->loadTemplate("admin/crumbs1.html", "admin/user/infoMessege.html", 3)->display($context);
        // line 4
...
\t\t\t\t\t\t{name: '用户id',val: 'um_user.username'},
...
";
    ...
    {
        return "admin/user/infoMessege.html";
    }
